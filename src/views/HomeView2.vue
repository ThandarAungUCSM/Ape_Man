<template>
  ...
  <div class="second-block">
    <img alt="" class="carouselbg-css" src="@/assets/images/carousel-bg1.png" />
    <div class="overlap-info">
      ...
      <div class="title-info">
        ...
        <div id="polyActive" class="polygonimgcss"></div>
      </div>
    </div>
  ...
  <div class="third-block" >
    ...
    <div class="overlap-info">
      <div class="title-info">
        <img alt="" class="rightarrowimg" src="@/assets/images/left-arrow.png" />
      ...
      <p class="third-block-content cssanimation sequence leRotateYZoomIn">有比地。隨早小個懷當是許被角就部人美人專；結禮不生斯，法起年不說面位動：題了得教人落情美病力信國覺，許動為部高地觀燈學層起人開意、者商之達期，情種處，自了面的於人何後畫還務只發沒施影三，整精來！死人告稱小現對報可怎十教男出時收音氣回魚取了中前變個；的太著進不。的我會華值職道陸，兒人新過，防土主素的野全道由式學象成力如。</p>
    </div>
  </div>
  <div class="fourth-block">
    <img alt="" class="thirdbg-css" src="@/assets/images/fourth-bg.png" />
    <div class="overlap-info">
      <div class="title-info">
        <img alt="" class="rightarrowimg" src="@/assets/images/left-arrow.png" />
        <span class="latest-infotext">角色職業</span>
        <img alt="" class="leftarrowimg" src="@/assets/images/right-arrow.png" />
      </div>
      <div class="title-info">
        <div class="polygonimgcss"></div>
      </div>
      <div class="card-row">
        <div class="ani-cardrow">
          ...
          <RouterLink to="/character-info" class="each-card activecard">
            ...
            <img alt="" class="absoDiam topLdiamon" src="@/assets/images/tldiamond.png" />
            <img alt="" class="absoDiam topRdiamon" src="@/assets/images/diamond.png" />
            <img alt="" class="absoDiam bottomLdiamon" src="@/assets/images/bldiamond.png" />
            <img alt="" class="absoDiam bottomRdiamon" src="@/assets/images/brdiamond.png" />
            <div class="child-act">
              <p class="txt1">職業名稱</p>
              <p class="txt2">-敘述敘述-</p>
            </div>
  ...
  <div class="five-block">
    ...
    <div class="overlap-info">
      ...
      <p class="third-block-content cssanimation sequence1 leRotateYZoomIn">
        死人告稱小現對報可怎十教男出時收音氣回魚取了中前變個；的太著進不。的我會華值職道陸，兒人新過，防土主素的野全道由式學象成力如。
      </p>
      <div class="five-videoblock">
...
export default defineComponent({
  ...
  methods: {
    ...
    handleScroll() {
      ...
      this.secPoly = document.getElementById('polyActive');
      
      if(this.isScrolledIntoView(this.secLeftel)) {
