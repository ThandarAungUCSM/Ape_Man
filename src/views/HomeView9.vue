    ...
    handleScroll() {
      ...
      if((this.secondBlockId.offsetTop) > pixel1) {
        ...
        if(this.oldScroll > pixel1){
          console.log('Scrolling up ' + this.oldScroll + " " + pixel1);
          const pixels = window.pageYOffset
          if(pixels < this.fiveBlockId.offsetTop ) {
            this.temp5 = 0;
          }
        }
        else{
        ...
        if(this.oldScroll > pixel1){
          console.log('Scrolling up ' + this.oldScroll + " " + pixel1);
          const pixels = window.pageYOffset
          if(pixels < this.sixBlockId.offsetTop ) {
            this.temp6 = 0;
          }
        }
        else{
        ...
        if(this.oldScroll > pixel1){
          console.log('Scrolling up ' + this.oldScroll + " " + pixel1);
          const pixels = window.pageYOffset
          if(pixels < this.sevenBlockId.offsetTop ) {
            this.temp7 = 0;
          }
        }
        else{
      ...
      } else if(this.sevenBlockId.offsetTop < pixel1) {
        console.log('7')
        if(this.oldScroll > pixel1){
          console.log('Scrolling up ' + this.oldScroll + " " + pixel1);
          const pixels = window.pageYOffset
          if(pixels < this.eightBlockId.offsetTop ) {
            this.temp8 = 0;
          }
        }
        else{
