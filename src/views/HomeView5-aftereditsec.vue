  ...
  methods: {
    ...
    isScrolledIntoView(el) {
      ...
      if(el.id == 'eightId') {
        ...
        var varone = this.firstBlockId.offsetHeight;
        var isVisible = (this.secondBlockId.offsetTop + (this.secondBlockId.offsetHeight/2))  >= pixels && offsetBottom1 > pixels;
        // var isVisible = this.secondBlockId.offsetTop >= pixels && offsetBottom1 > pixels;
        
        // var isVisible = (this.secondBlockId.offsetTop + (this.secondBlockId.offsetHeight/2))  >= pixels && offsetBottom1 > pixels;
        // if(window.innerHeight > varone) {
          //   console.log(isVisible)
          // } else 
          // if(varone > window.innerHeight && pixels == 0) {
          //   console.log(varone + " " + window.innerHeight + " " + pixels + " " + isVisible)
          ...
          // } 
        // console.log('hi ' + this.firstBlockId.offsetHeight + " " + pixels);
    ...
    handleScroll() {
      ...
      // var rect = this.secondBlockId.getBoundingClientRect();
      // var elemTop = rect.top;
      // var elemBottom = rect.bottom;
      // var isVisible = elemTop <= window.innerHeight && elemBottom > window.innerHeight;
      // if(isVisible) {
