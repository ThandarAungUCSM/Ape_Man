...
export default defineComponent({
  ...
  methods: {
    ...
    isScrolledIntoView(el) {
      ...
      // if (this.secondBlockId.offsetTop <= pixels && offsetBottom > pixels) {
    ...
    handleScroll() {
      ...
      this.secPoly = document.getElementById('polyId2');
      ...
      if(this.isScrolledIntoView(this.secondBlockId)) {
        ...
        this.slickImg.classList.add('slickAni');
      } else {
        ...
        this.slickImg.classList.remove('slickAni');
      }
      ...
      this.bottomlData = document.getElementById('bottomlId');
      this.bottomrData = document.getElementById('bottomrId');
      this.bottomPartData = document.getElementById('childActId');
