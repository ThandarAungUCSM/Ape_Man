  ...
  <div class="fourth-block">
    ...
    <div class="overlap-info">
      ...
      <div class="card-row">
        ...
        <div class="each-card activecard">
          ...
          <img alt="" class="absoDiam topLdiamon" src="@/assets/images/diamond.png" />
          <img alt="" class="absoDiam topRdiamon" src="@/assets/images/diamond.png" />
          <img alt="" class="absoDiam bottomLdiamon" src="@/assets/images/diamond.png" />
          <img alt="" class="absoDiam bottomRdiamon" src="@/assets/images/diamond.png" />
          <div class="child-act">
            <p class="txt1">職業名稱</p>
            <p class="txt2">-敘述敘述-</p>
          </div>
...
.polygonimgcss {
  ...
  // clip-path: polygon(50% 48%, 100% 49%, 51% 51%, 0 49%);
